...
columns = [
    ...
    f"{DBUsersColumns.ALIQUOTA_TAX.value} REAL NOT NULL",
    f"{DBUsersColumns.ALIQUOTA_INPS.value} REAL NOT NULL",
    f"{DBUsersColumns.ALIQUOTA_IVA.value} REAL NOT NULL",
    f"{DBUsersColumns.ALIQUOTA_CASSA_INPS.value} REAL NOT NULL",
    f"{DBUsersColumns.ALIQUOTA_RIVALSA_INPS.value} REAL NOT NULL",
    f"{DBUsersColumns.ALIQUOTA_RITENUTA_ACCONTO.value} REAL NOT NULL",
    f"{DBUsersColumns.REGIME_FISCALE.value} TEXT NOT NULL",
    f"{DBUsersColumns.IMPONIBILE_IVA.value} REAL NOT NULL",
    f"{DBUsersColumns.IMPONIBILE_TAX.value} REAL NOT NULL",
    f"{DBUsersColumns.IMPONIBILE_CASSA_INPS.value} REAL NOT NULL",
    f"{DBUsersColumns.IMPONIBILE_INPS.value} REAL NOT NULL",
