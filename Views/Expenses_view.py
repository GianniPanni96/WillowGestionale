...
class ExpensesView(ctk.CTkFrame):
    ...
    def create_expenses_tab(self):
        ...
        self.table_headers = ["NOME", "FORNITORE", "NETTO", "LORDO", "CATEGORIA", "DATA\nEMISSIONE", "DEDUCIBILE", "DEDUZIONE A\nCARICO DI", "CONTO\nCORRENTE"]
    ...
    def sort_cards(self):
        ...
        sort_mapping = {
            "TOTALE LORDO": ("direct", 3, _convert_to_currency, None),
            "DATA EMISSIONE": ("direct", 5, _convert_to_date, None),
    ...
    def toggle_user_deduzione(self, selected_value):
        ...
        if selected_value == "Sì":
            ...
            for key in keys_to_manage:
                ...
                a = self.expenses_widgets[DBExpensesColumns.CATEGORY.value].get_value()
